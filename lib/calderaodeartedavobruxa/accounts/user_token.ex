defmodule Calderaodeartedavobruxa.Accounts.UserToken do
  use Ecto.Schema
  import Ecto.Query
  alias Calderaodeartedavobruxa.Accounts.UserToken
  ...
  schema "users_tokens" do
    ...
    belongs_to :user, Calderaodeartedavobruxa.Accounts.User
