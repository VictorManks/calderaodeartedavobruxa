defmodule CalderaodeartesdavobruxaWeb.Router do
  use CalderaodeartesdavobruxaWeb, :router

  import CalderaodeartesdavobruxaWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {CalderaodeartesdavobruxaWeb.Layouts, :root}
  ...
  scope "/", CalderaodeartesdavobruxaWeb do
  ...
  # scope "/api", CalderaodeartesdavobruxaWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:calderaodeartesdavobruxa, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: CalderaodeartesdavobruxaWeb.Telemetry
  ...
  scope "/", CalderaodeartesdavobruxaWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{CalderaodeartesdavobruxaWeb.UserAuth, :require_authenticated}] do
